...
{
    public abstract class AspNetZeroOrganisationUnitCloneWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspNetZeroOrganisationUnitCloneWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspNetZeroOrganisationUnitCloneWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspNetZeroOrganisationUnitCloneDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspNetZeroOrganisationUnitCloneDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspNetZeroOrganisationUnitCloneDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspNetZeroOrganisationUnitCloneDbContext, Task<T>> func)
        {
            T result;
