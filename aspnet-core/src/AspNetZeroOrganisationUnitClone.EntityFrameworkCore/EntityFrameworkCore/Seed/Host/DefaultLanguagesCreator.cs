...
namespace AspNetZeroOrganisationUnitClone.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly AspNetZeroOrganisationUnitCloneDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = AspNetZeroOrganisationUnitCloneConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspNetZeroOrganisationUnitCloneDbContext context)
        {
            _context = context;
        }
